...
#define BPRINT(x, ...) PRINT(x, __VA_ARGS__) && PRINT("		Test : %s", x)
#define CPRINT(x, a, b, ...) PRINT(x, a, b, __VA_ARGS__) && PRINT("		Test : %s with width = %d and precision = %d", x, a, b, __VA_ARGS__) 
...
int main()
{
	...
	PRINT("\n");
	ret[++count] = BPRINT("%i, %d, %d, %d, %d, %s, %c, %d", i, j, k, l, m, n, c, c); //T2
	PRINT("\n");
	...
	while (a < 5) //T34-69
	{
		ret[++count] = CPRINT("%*i, %*d, %*d, %*d, %*d, %*d", a, i, a, j, a, k, a, l, a, m, a, c);
		PRINT("\n");
		ret[++count] = CPRINT("%0*i, %0*d, %0*d, %0*d, %0*d, %0*d", a, i, a, j, a, k, a, l, a, m, a, c);
		PRINT("\n");
		ret[++count] = CPRINT("%-*i, %-*d, %-*d, %-*d, %-*d, %-*d", a, i, a, j, a, k, a, l, a, m, a, c);
		PRINT("\n");
		ret[++count] = CPRINT("%.*i, %.*d, %.*d, %.*d, %.*d, %.*d", a, i, a, j, a, k, a, l, a, m, a, c);
	...
	ret[++count] = PRINT("%*.*i, %*.*d", 9, 4, -42, 9, 4, 42);
	PRINT("\n");
